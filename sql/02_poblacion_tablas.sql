...
INSERT INTO empleado (Nombre, Posicion, Departamento, sucursal_id, Rol) VALUES
...
INSERT INTO ordenes(cliente_id, empleado_id, sucursal_id, mensajero_id, tipo_de_pago_id, origen_order_id, horario_venta, total_compra, kilometros_recorrer, fecha_despacho, fecha_entrega, fecha_orden_tomada, fecha_orden_lista) VALUES
...
UPDATE producto SET precio = Precio + 1 WHERE categoria_id = 1;

-- Cambiar la posición de todos los empleados del departamento 'Cocina' a 'Chef'
UPDATE empleado SET Posicion = 'Chef' WHERE Departamento = 'Cocina';

-- Actualizar la dirección de una sucursal específica
UPDATE sucursal SET direccion= '1234 New Address St' WHERE id = 1;
...
DELETE FROM orden_producto WHERE orden_id = 10;
DELETE FROM Ordenes WHERE id = 10;
...
DELETE FROM empleado WHERE sucursal_id = 10;
...
--Cantidad de ordenes unicas
SELECT DISTINCT(COUNT(ordenes.id)) AS ordenes_unicas 
FROM ordenes
...
SELECT departamento,COUNT(*) AS cantidad_por_departamento 
FROM empleado
...
SELECT	 categoria_id,COUNT(*) AS cantidad_por_categoria
FROM producto
...
--Sucursales con promedio mayor a 1000.00
SELECT sucursal_id,total_compra, kilometros_recorrer
FROM ordenes
WHERE total_compra>1000
ORDER BY kilometros_recorrer DESC
